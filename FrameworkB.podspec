#
#  Be sure to run `pod spec lint FrameworkB.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "HienBD" => "hienbd@techcombank.com.vn" }
  # Or just: spec.author    = "HienBD"
  # spec.authors            = { "HienBD" => "hienbd@techcombank.com.vn" }
  # spec.social_media_url   = "https://twitter.com/HienBD"
